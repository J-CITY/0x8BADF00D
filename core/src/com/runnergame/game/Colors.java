...
public class Colors {
    ...
    Colors() {
        ...
        playerSkinsPrice.add(20);
        playerSkins.add("6_p.png");
        playerSkinsPrice.add(25);
        playerSkins.add("7_p.png");
        playerSkinsPrice.add(30);
        playerSkins.add("8_p.png");
        playerSkinsPrice.add(35);
        playerSkins.add("9_p.png");
        playerSkinsPrice.add(40);
        playerSkins.add("10_p.png");
        playerSkinsPrice.add(45);
        playerSkins.add("11_p.png");
        playerSkinsPrice.add(50);
        playerSkins.add("12_p.png");
        playerSkinsPrice.add(55);
        playerSkins.add("13_p.png");
        playerSkinsPrice.add(60);
        playerSkins.add("14_p.png");
        playerSkinsPrice.add(65);
        playerSkins.add("15_p.png");
        playerSkinsPrice.add(70);
        playerSkins.add("16_p.png");
        playerSkinsPrice.add(75);
        playerSkins.add("17_p.png");
        playerSkinsPrice.add(80);
        playerSkins.add("18_p.png");
        playerSkinsPrice.add(85);
        playerSkins.add("19_p.png");
        playerSkinsPrice.add(90);
    }
